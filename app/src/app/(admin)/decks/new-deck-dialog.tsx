      ...
      <DialogContent>
        <form onSubmit={submit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Creates decks/{slugValue || "slug"} and copies one preset in as
              the first slide. Add the rest from the deck screen.
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              <Label htmlFor="deck-preset">First slide</Label>
